...
class wb_dionysus_sdramDriver(driver.Driver):

    """ wb_dionysus_sdram

        Communication with a DutDriver wb_dionysus_sdram Core
    """
    @staticmethod
    def get_abi_class():
        return 0
    ...
    def __init__(self, nysa, urn, debug = False):
        super(wb_dionysus_sdramDriver, self).__init__(nysa, urn, debug)
